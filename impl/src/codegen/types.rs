        ...
        Type::Path(type_path) => match type_path.path.segments.len() {
            ...
            1 => {
                ...
                match path_segment.ident.to_string().as_str() {
                    "bool" => Some((
                        quote! {surrealdb_obj_derive::surrealdb::sql::Kind::Bool},
                        false,
                    )),
                    "String" | "str" => Some((
                        quote! {surrealdb_obj_derive::surrealdb::sql::Kind::String},
                        false,
                    )),
                    "u8" | "u16" | "u32" | "u64" | "usize" => Some((
                        quote! {surrealdb_obj_derive::surrealdb::sql::Kind::Int},
                        false,
                    )),
                    "i8" | "i16" | "i32" | "i64" | "isize" => Some((
                        quote! {surrealdb_obj_derive::surrealdb::sql::Kind::Int},
                        false,
                    )),
                    "f32" | "f64" => Some((
                        quote! {surrealdb_obj_derive::surrealdb::sql::Kind::Float},
                        false,
                    )),
                    "Option" => {
